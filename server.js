...
connection.connect((error) => {
  ...
  console.log(``);
  console.log(chalk.greenBright.bold('Employee Manager'));
  console.log(``);
  console.log(chalk.yellow.bold(`====================================================================================`));
  promptUser();
});
...
const viewAllEmployees = () => {
  let sql =       `SELECT employee.id, 
                    ...
                    FROM   employee 
                          LEFT JOIN (SELECT employee.id                        AS manager_id, 
...
const viewAllRoles = () => {
  ...
  console.log(chalk.yellow.bold(`====================================================================================`));
  const sql =     `SELECT role.id, role.title, department.department_name AS department, salary
                  FROM role
